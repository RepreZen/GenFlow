...
public class CommonServices {
     ...
     * 
     * @param message
     *            {@link com.modelsolv.reprezen.restapi.TypedMessage} to check
     * @return Boolean
     */
    ...
    public String getPrettyPrintedCardinality(PropertyRealization includedProperty) {
        ...
        if (includedProperty.getCardinality() != null) {
            ...
            cardinality = FeatureCardinalities.getFeatureCardinalities().getCardinality(
                    includedProperty.getBaseProperty());
        }
        return cardinality.getLabel();
    }
    ...
    /**
     * @param ele
     *            element to search parent container
     * @param type
     *            type of parent
