 ...
 * <ul>
 * <li><strong>GenTemplates</strong> turn one or more source files into output
 * files.
 * <li><strong>GenTargets</strong> provide run-time values - such as string
 ...
 * <li><strong>Dependencies</strong> define the values that must be supplied by
 * a GenTarget when executing a particular GenTemplate
 * <li><strong>Trace</strong> information constitutes "bread crumbs" left behind
 ...
 * <li>The framework includes specializations for many of the above for specific
