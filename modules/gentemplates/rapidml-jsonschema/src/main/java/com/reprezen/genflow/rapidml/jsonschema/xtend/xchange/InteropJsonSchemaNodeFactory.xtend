...
import com.reprezen.genflow.rapidml.jsonschema.xtend.builder.ObjectResourceNode
import com.reprezen.genflow.rapidml.jsonschema.xtend.builder.StructureNode
