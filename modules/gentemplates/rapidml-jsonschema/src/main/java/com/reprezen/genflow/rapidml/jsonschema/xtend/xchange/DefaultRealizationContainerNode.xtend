...
import com.reprezen.genflow.rapidml.jsonschema.xtend.builder.PropertyRealizationNode
import com.reprezen.genflow.rapidml.jsonschema.xtend.builder.TypedMessageNode
