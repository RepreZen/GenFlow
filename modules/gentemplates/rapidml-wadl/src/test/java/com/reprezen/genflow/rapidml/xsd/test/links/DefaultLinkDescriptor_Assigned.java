...
@SampleRestFile("links/DefaultDescriptor_MultipleDescriptorsWAssigned.rapid")
public class DefaultLinkDescriptor_Assigned {
    @Rule
    ...
    public void testDataType1_NonContainmentReference1() throws Exception {
        ...
        assertNotNull(attr1);
        assertThat(attr1, hasType("xs:string"));

        Node attr2 = getAtomLinkAttribute("aProperty").apply(listItem);
        assertNotNull(attr2);
        assertThat(attr2, hasType("xs:boolean"));
