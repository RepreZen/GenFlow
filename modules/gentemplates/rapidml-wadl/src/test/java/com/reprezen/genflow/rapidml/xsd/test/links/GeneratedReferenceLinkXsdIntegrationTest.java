...
@SampleRestFile("links/SimpleReference.rapid")
public class GeneratedReferenceLinkXsdIntegrationTest {
    @Rule
    ...
    public void testTargetNamespace() throws Exception {
        ...
        assertThat(schema,
                hasTargetNamespace("http://modelsolv.com/reprezen/schemas/testdirectreference/testdirectreference"));
    }
