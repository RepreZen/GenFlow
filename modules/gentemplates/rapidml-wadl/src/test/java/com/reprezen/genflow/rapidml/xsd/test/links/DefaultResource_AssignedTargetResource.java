...
@SampleRestFile("links/DefaultResource_AssignedTargetResource.rapid")
public class DefaultResource_AssignedTargetResource {
    @Rule
    ...
    public void testGlobalTypeForDataType2() throws Exception {
        // There is no default Resource Definition for datatype2 => generate generate
