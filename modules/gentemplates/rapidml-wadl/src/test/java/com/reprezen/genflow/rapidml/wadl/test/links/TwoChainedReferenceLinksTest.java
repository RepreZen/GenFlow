...
public class TwoChainedReferenceLinksTest {

    public static String TWO_CHAINED_REFERENCES_SAMPLE_XML = "twoChainedReferences_dataType1Object.xml";

    private static final String XPATH_LINK1 = "/twochainedreferences:dataType1Object"
            + "/twochainedreferences:dataType1_containment1" + "/twochainedreferences:dataType2_reference1"
            + "/atom:link";

    private static final String XPATH_LINK2 = "/twochainedreferences:dataType1Object"
            + "/twochainedreferences:dataType1_containment1" + "/twochainedreferences:dataType2_reference2"
            + "/atom:link";

    private static final String XSD_PREFIX = "twochainedreferences";
    ...
    public void testNsDeclarationForGrammar() throws Exception {
        ...
        assertThat(app, hasValue("xmlns:" + XSD_PREFIX,
                "http://modelsolv.com/reprezen/schemas/twochainedreferences/twochainedreferences"));
    }

    @Test
    public void testReferenceToGrammar() throws Exception {
        fixture.requireGrammar("twoChainedReferences.xsd");
    }
    ...
    public void testGetDataType1Resource_MethodResponseWithLinkedResources() throws Exception {
        ...
        }
        {
            ...
            assertThat(param, hasName("dataType2_reference2"));
    ...
    public void testRepresentationParameter1UsesValidXpathQuery() throws Exception {
        NodeList result = fixture.querySampleXml(TWO_CHAINED_REFERENCES_SAMPLE_XML, XPATH_LINK1);
        // one link
    ...
    public void testRepresentationParameter2UsesValidXpathQuery() throws Exception {
        NodeList result = fixture.querySampleXml(TWO_CHAINED_REFERENCES_SAMPLE_XML, XPATH_LINK2);
        // single link
        assertThat(result.getLength(), equalTo(1));
    }
