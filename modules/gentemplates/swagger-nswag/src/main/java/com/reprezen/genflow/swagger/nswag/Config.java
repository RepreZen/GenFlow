...
public class Config {
    ...
    /*
     * Most of the member variables are part of the "run" file that is produced to drive NSwag. The @NSwagParam
     * annotation captures which "outputs" the parameter applies to, as well as documentation and default value. To get
     * around limitations in annotation member types, default values appear as strings, but any value that begins with
     * "JSON:" is parsed to yield a JSON object, and that object is used.
     * 
     * This class is capable of doing three important and related things:
     * 
     * 1. Define parameter definitions for a gentemplate for whichever output the gentemplate is for.
     * 
